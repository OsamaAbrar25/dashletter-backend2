...
var fs = require('fs')
 ...
 '../asset/category/pet.json', '../asset/category/gaming.json', '../asset/category/random.json']
...
query = ['fashion clothing blog', 'food blog', 'travel blog', 'music blog', 'lifestyle blog', 'fitness blog', 'DIY blog', 'sports blog', 'finance blog',
 'political blog', 'parenting blog', 'business blog', 'personal blog', 'movie blog', 'car blog', 'news blog', 'pet dog cat blog', 'gaming blog', 'blog']
